...
Vector3 ME::Vector2::ToVector3()const
{
	return Vector3(x, y, 0);
}

//Quaternion ME::Vector2::ToQuaternion()const
//{
//	return Quaternion(1, x, y, 0);
//}

Vector2 ME::Vector2::ToVector2(const Vector3& v)
{
	return Vector2(v.x, v.y);
}

//Vector2 ME::Vector2::ToVector2(const Quaternion& q)
//{
//	return Vector2(q.x, q.y);
//}

Vector2 ME::Vector2::ToVector2(const DirectX::XMFLOAT2& f)
{
...
Vector2 ME::operator+(const Vector2& vector1, const Vector2& vector2)
{
...
Vector2 ME::operator+(const Vector2& vector, const float f)
{
...
Vector2 ME::operator+(const float f, const Vector2& vector)
{
...
Vector2 ME::Vector2Normalize(const Vector2& vector)
{
...
/// <returns></returns>
float ME::Vector2Dot(const Vector2& vector1, const Vector2& vector2)
{
	return vector1.x * vector2.x + vector1.y * vector2.y;
}

float ME::Vector2Cross(const Vector2& vector1, const Vector2& vector2)
{
...
//ME::Vector3::Vector3(const GuiVector3& value)
//{
//	x = value.GetValue().x;
//	x = value.GetValue().y;
//	x = value.GetValue().z;
...
Vector3 ME::Vector3::ToVector3(const Vector2& v)
{
	return Vector3(v.x, v.y, 0);
}

//Vector3 ME::Vector3::ToVector3(const Quaternion& q)
//{
//	return Vector3(q.x, q.y, q.z);
//}

Vector3 ME::Vector3::ToVector3(const DirectX::XMFLOAT3& f)
{
...
Vector3 ME::operator+(const Vector3& vector1, const Vector3& vector2)
{
...
Vector3 ME::operator+(const Vector3& vector, const float f)
{
...
Vector3 ME::operator+(const float f, const Vector3& vector)
{
...
float& ME::Vector3::operator[](const unsigned int num)
{
	if (num == 0)return x;
	else if (num == 1)return y;
	else if (num == 2)return z;

	//ME::ErrorProcess::GetInstance()->StartErroeProcess(L"Vector3の範囲を超えています。[]内の数値を2以下にしてください。", true);
}
...
//std::vector<Vector3> ME::Vector3::Sort(const std::vector<Vector3>& vectors, const Vector3& standardVec, const SortType type)
//{
...
/// <returns></returns>
Vector3 ME::Vector3Normalize(const Vector3& vector)
{
...
/// <param name="vector2"></param>
/// <returns></returns>
Vector3 ME::Vector3Cross(const Vector3& vector1, const Vector3& vector2)
{
	Vector3 cross;
...
/// <param name="vector2"></param>
/// <returns></returns>
float ME::Vector3Dot(const Vector3& vector1, const Vector3& vector2)
{
	return vector1.x * vector2.x + vector1.y * vector2.y + vector1.z * vector2.z;
}
#pragma endregion
